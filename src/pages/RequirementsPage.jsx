...
export function RequirementsPage() {
  ...
  const runStatusMap = useMemo(() => buildRunStatusMap(runs), [runs])
  ...
  const filteredTcs = testCases
    .filter((tc) => testCaseMatchesSearch(tc, tcSearch))
    .sort((a, b) => (a.sourceTcId || '').localeCompare(b.sourceTcId || ''))
      ...
      {totalReqs > 0 && (
        <section className="req-coverage-strip">
          ...
          <div className="req-coverage-stats">
            ...
            <div className="req-stat">
              <span className="req-stat-dot req-stat-dot--inprogress" />
