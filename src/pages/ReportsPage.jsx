...
const getTestCases = (projectId) => getCachedProjectData(projectId).testCases
const getBugs = (projectId) => getCachedProjectData(projectId).bugs
const getTestRuns = (projectId) => getCachedProjectData(projectId).runs
